...
pub enum SolEarnError {
    ...
    #[msg("Number of employees in Organization don't match number of payout accounts!")]
    ...
    #[msg("Salary already claimed!")]
    SalararyClaim,

    #[msg("All Employees on this Payroll have been paid!")]
    PayrollInactive,
}
